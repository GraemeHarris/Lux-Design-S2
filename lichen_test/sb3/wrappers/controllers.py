...
class SimpleUnitDiscreteController(Controller):
    def __init__(self, env_cfg) -> None:
        ...
        self.factory_act_dims = 3
        self.factory_dim_high = self.no_op_dim_high + self.factory_act_dims

        self.total_act_dims = self.no_op_dim_high + self.factory_act_dims
    ...
    def _is_factory_action(self, id):
